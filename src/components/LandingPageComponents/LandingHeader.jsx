...
// Assets
import HeaderImage from "../../assets/images/landing.jpg";
import QuotesIcon from "../../assets/images/Quotes";
  ...
  return (
    <Wrapper id="home" className="container flexSpaceCenter">
      <LeftSide className="flexCenter">
        <div>
          <h1 className="extraBold font60">We are Course Managment Agency.</h1>
